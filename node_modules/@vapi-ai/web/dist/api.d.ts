export declare class CreateWebCallDTO {
    /**
...
export interface OpenAIModel {
    ...
    model: 'gpt-4-turbo' | 'gpt-4-turbo-2024-04-09' | 'gpt-4-turbo-preview' | 'gpt-4-0125-preview' | 'gpt-4-1106-preview' | 'gpt-4' | 'gpt-4-0613' | 'gpt-3.5-turbo' | 'gpt-3.5-turbo-0125' | 'gpt-3.5-turbo-1106' | 'gpt-3.5-turbo-16k' | 'gpt-3.5-turbo-0613';
    /**
     ...
     */
    fallbackModels?: 'gpt-4-turbo' | 'gpt-4-turbo-2024-04-09' | 'gpt-4-turbo-preview' | 'gpt-4-0125-preview' | 'gpt-4-1106-preview' | 'gpt-4' | 'gpt-4-0613' | 'gpt-3.5-turbo' | 'gpt-3.5-turbo-0125' | 'gpt-3.5-turbo-1106' | 'gpt-3.5-turbo-16k' | 'gpt-3.5-turbo-0613';
    /** @example true */
...
export interface CreateAssistantDTO {
    ...
    model?: OpenAIModel | TogetherAIModel | AnyscaleModel | OpenRouterModel | PerplexityAIModel | DeepInfraModel | GroqModel | AnthropicModel | CustomLLMModel;
    /**
     ...
     */
    serverMessages?: ('status-update' | 'transcript' | 'hang' | 'function-call' | 'tool-calls' | 'end-of-call-report' | 'conversation-update' | 'phone-call-control' | 'model-output' | 'voice-input')[];
    /**
...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    ...
    credential: {
        ...
        credentialControllerCreate: (data: ({
            ...
            provider: 'vonage';
        } & CreateVonageCredentialDTO), params?: RequestParams) => Promise<HttpResponse<({
            provider: 'twilio';
        } & TwilioCredential) | ({
            provider: 'deepgram';
        } & DeepgramCredential) | ({
         ...
         * @secure
         */
        credentialControllerFindOne: (id: string, params?: RequestParams) => Promise<HttpResponse<({
            provider: 'twilio';
        } & TwilioCredential) | ({
            provider: 'deepgram';
        } & DeepgramCredential) | ({
        ...
        credentialControllerUpdate: (id: string, data: ({
            ...
            provider: 'vonage';
        } & UpdateVonageCredentialDTO), params?: RequestParams) => Promise<HttpResponse<({
            provider: 'twilio';
        } & TwilioCredential) | ({
            provider: 'deepgram';
        } & DeepgramCredential) | ({
         ...
         * @secure
         */
        credentialControllerRemove: (id: string, params?: RequestParams) => Promise<HttpResponse<({
            provider: 'twilio';
        } & TwilioCredential) | ({
            provider: 'deepgram';
        } & DeepgramCredential) | ({
    ...
    phoneNumber: {
         ...
         * @secure
         */
        phoneNumberControllerBuy: (data: BuyPhoneNumberDTO, params?: RequestParams) => Promise<HttpResponse<PhoneNumber, any>>;
        /**
         * No description
         *
         * @tags Phone Numbers
         ...
         * @secure
         */
        phoneNumberControllerImportTwilio: (data: ImportTwilioPhoneNumberDTO, params?: RequestParams) => Promise<HttpResponse<PhoneNumber, any>>;
        /**
         * No description
         *
         * @tags Phone Numbers
         ...
         * @secure
         */
        phoneNumberControllerImportVonage: (data: ImportVonagePhoneNumberDTO, params?: RequestParams) => Promise<HttpResponse<PhoneNumber, any>>;
        /**
         * No description
         *
         * @tags Phone Numbers
        ...
        phoneNumberControllerFindAll: (query?: {
             ...
             */
            updatedAtLe?: string;
        }, params?: RequestParams) => Promise<HttpResponse<PhoneNumber[], any>>;
        /**
         * No description
         *
         * @tags Phone Numbers
         ...
         * @secure
         */
        phoneNumberControllerFindOne: (id: string, params?: RequestParams) => Promise<HttpResponse<PhoneNumber, any>>;
        /**
         * No description
         *
         * @tags Phone Numbers
         ...
         * @secure
         */
        phoneNumberControllerUpdate: (id: string, data: UpdatePhoneNumberDTO, params?: RequestParams) => Promise<HttpResponse<PhoneNumber, any>>;
        /**
         * No description
         *
         * @tags Phone Numbers
         ...
         * @secure
         */
        phoneNumberControllerRemove: (id: string, params?: RequestParams) => Promise<HttpResponse<PhoneNumber, any>>;
    };
    metrics: {
        /**
         * No description
         ...
         * @secure
         */
        metricsControllerFindAll: (query?: {
            /**
    ...
    voiceLibrary: {
         ...
         * @secure
         */
        voiceLibraryControllerVoiceGetByProvider: (provider: '11labs' | 'playht' | 'rime-ai' | 'deepgram' | 'openai' | 'azure' | 'lmnt' | 'neets', params?: RequestParams) => Promise<HttpResponse<VoiceLibrary[], any>>;
        /**
         * No description
         *
         * @tags Voice Library
         ...
         * @secure
         */
        voiceLibraryControllerVoiceLibrarySyncByProvider: (provider: '11labs' | 'playht' | 'rime-ai' | 'deepgram' | 'openai' | 'azure' | 'lmnt' | 'neets', params?: RequestParams) => Promise<HttpResponse<VoiceLibrary[], any>>;
    };
    logging: {
        /**
         * No description
         ...
         * @secure
         */
        loggingControllerGetLogs: (query: {
            callId: string;
            /**
